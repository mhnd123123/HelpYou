...
-- تعديل مدة الضغط على E إلى 4 ثواني وإضافة Key System (المفتاح: Diving2030)
...
-- ================== إنشاء واجهة Rayfield مع Key System ==================
local function CreateUI()
    ...
    local Window = Rayfield:CreateWindow({
        ...
        KeySystem = true,  -- تفعيل نظام الكي
        KeySettings = {
            ...
            Key = {"Diving2030"}  -- المفتاح المطلوب
        }
    })
...
print("🔑 Key System مفعل - المفتاح: Diving2030")
